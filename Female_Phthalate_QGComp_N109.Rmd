---
title: "Female_QGComp for GAPPS Phthalates"
...
## Female QGComp for GAPPS RNAseq and PHthalate Data
...
PHT<-read.csv("/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Female/Female_Phthalate_CleanedLogData_GeoMean_LN_N109_041625.csv")
...
Not including smoking here since there are too few participants to estimate for that variable.
```{r covar prep}

Covariates_Selected <- covar_final %>%
  dplyr::select(pathways_id, labor_collapsed, h_del_method, h_m_delivery_age, h_m_prepreg_bmi, h_m_ethn, race_collapsed, edu_collapsed, parity_20,SG, batch)

covars <- c("labor_collapsed", "h_del_method", "h_m_delivery_age", "h_m_prepreg_bmi", "h_m_ethn", "race_collapsed", "edu_collapsed", "parity_20", "SG", "batch")
...
#save(ewas_qgcomp_fit.boot, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Female/Female_GAPPS_Phthalate_QGCompResults_071625.Rdata")
```
