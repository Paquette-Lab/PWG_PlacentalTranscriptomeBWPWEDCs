---
title: "Phthalate_Covar_RNAseq_DataCleaning_Male_GAPPS"
...
## Males-Phthalate, Covariate, and RNAseq Data Cleaning- GAPPS
This code clean covariate data, RNAseq data, and phthalate data for a male subset of the sample resulting in a final N=113 for the male-stratified phthalate RNAseq analyses.
...
covar_rnaseq <- covar %>%
  ...
  dplyr::filter(h_c_sex=="M") #filter for only males
...
print(summary_rawdata)
 ...
 #Log transform and visualize
   ...
   boxplot(Log_PHT,Title="Log Phthalates (Average)") 
...
### Add BWPW to covars
Not planning to use this set since the number is so much lower (N=113 vs N=83), but just seeing what the overlap is with subset that has BWPW. 
```{r bwpw}
...
covar_check <- na.omit(covar_final) #N=83
```
...
ggplot(PHT_Sites, aes(x=Phthalate, y=LogConc, fill=Site)) +
  ...
  ggtitle("Male-Phthalate Concentration by Site")
...
ggplot(PHT_Sites, aes(x=Phthalate, y=LogConc, fill=City)) +
  ...
  ylab("Natural Log Concentration (ng/mL)") + 
  xlab("Phthalate Metabolite") + 
  ggtitle("Male-Phthalate Concentration by City")
```
...
### Save Data
```{r save}
#write.csv(summary_rawdata, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_Phthalate_RawDataSummary_GeoMean_N113_041625.csv")
#write.csv(PHT, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_Phthalate_CleanedRawData_GeoMean_N113_041625.csv")
#write.csv(Log_PHT, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_Phthalate_CleanedLogData_GeoMean_LN_N113_041625.csv")
#save(covar_final, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_FinalCovariates_N113_041625.Rdata")
#save(Y_norm, annot, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_FilteredNormalizedRNAseq_N113_041625.RData")
#write.csv(Table, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_AboveLODNumbers_N113_041625.csv")
#write.csv(T1_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_T1_LOD_Summary_041625.csv")
#write.csv(T2_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_T2_LOD_Summary_041625.csv")
#write.csv(T3_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_T3_LOD_Summary_041625.csv")
```
