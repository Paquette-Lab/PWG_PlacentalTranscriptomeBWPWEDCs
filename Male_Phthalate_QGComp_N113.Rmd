---
title: "Male_QGComp for GAPPS Phthalates"
...
## Male QGComp for GAPPS RNAseq and PHthalate Data
...
PHT<-read.csv("/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_Phthalate_CleanedLogData_GeoMean_LN_N113_041625.csv")
...
Note- not including smoking since tehre are not enough for a proper contrast
```{r covar prep}
...
#save(ewas_qgcomp_fit.boot, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Male/Male_GAPPS_Phthalate_QGCompResults_GeoMean_071125.Rdata")
```
