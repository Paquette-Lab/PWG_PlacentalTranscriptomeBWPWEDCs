---
title: "Phthalate_Covar_RNAseq_DataCleaning_GAPPS"
...
print(summary_rawdata)
 ...
 #Log transform and visualize
   ...
   boxplot(Log_PHT,Title="Log Phthalates (Geometric Mean)") 
...
sum(duplicated(covar_final$pathways_id))

```

### Add BWPW to covars
Not planning to use this set since the number is so much lower (N=222 vs N=164), but just seeing what the overlap is with subset that has BWPW. 
```{r bwpw}
...
covar_check <- na.omit(covar_final) #N=165
```
...
### Save Data
```{r save}
#write.csv(summary_rawdata, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Phthalate_RawDataSummary_GeoMean_N223_041525.csv")
#write.csv(PHT, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Phthalate_CleanedRawData_GeoMean_N222_041525.csv")
#write.csv(Log_PHT, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/Phthalate_CleanedLogData_GeoMean_LN_N222_041525.csv")
#save(covar_final, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/FinalCovariates_N222_041525.Rdata")
#save(Y_norm, annot, file="/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/FilteredNormalizedRNAseq_N222_041525.RData")
#write.csv(Table, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/AboveLODNumbers_N222_041525.csv")
#write.csv(T1_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/T1_LOD_Summary_041525.csv")
#write.csv(T2_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/T2_LOD_Summary_041525.csv")
#write.csv(T3_LOD_Summary, "/Volumes/paquette_a/GAPPSGrant_PrelimData/Sam/Data/T3_LOD_Summary_041525.csv")
```
